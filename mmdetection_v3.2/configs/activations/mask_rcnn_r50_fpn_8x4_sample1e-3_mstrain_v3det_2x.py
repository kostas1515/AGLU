_base_ = [
    '../_base_/models/mask-rcnn_r50_fpn.py', '../_base_/datasets/v3det_sam.py',
...
model = dict(
    roi_head=dict(
        bbox_head=dict(
            ...
            mask_head=dict(num_classes=13204,
                           predictor_cfg=dict(type='NormedConv2d', tempearture=50),
                           loss_mask=dict(
    ...
    test_cfg=dict(
        rcnn=dict(
            ...
            max_per_img=300)))
# dataset settings
train_dataloader = dict(batch_size=3, num_workers=8)
fp16 = dict(loss_scale=512.) 

# training schedule for 2x
max_iter = int(68760 * 2 *(4/3))
train_cfg = dict(
    _delete_=True,
...
param_scheduler = [
    ...
    dict(
        ...
        by_epoch=False,
        milestones=[int(45840 * 2 *(4/3)), int(63030 * 2 *(4/3))],
        gamma=0.1)
]
